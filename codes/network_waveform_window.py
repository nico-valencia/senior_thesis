...
eventdata = pd.read_csv('/work/gcl3/BR/nicolasv03/senior_thesis/data/'+data_type+'/'+station+'/'+data_tag+'_events_sep16.txt',sep='|')
...
# for i in range(100,101,1):
    ...
    try:
        ...
        eventdata.loc[evind,'freq'] = freqType
...
eventdata.to_csv(output_dir+'_windowed_events_'+freqType+'_sep16.txt', sep='|', index=False)
